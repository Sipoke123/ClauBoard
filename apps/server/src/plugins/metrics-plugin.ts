 ...
 *
 * Exposed as a factory so each PluginRegistry instance gets its own state.
 */
...
export function createMetricsPlugin(): PluginDefinition {
...
/** Convenience singleton for backwards compatibility */
export const metricsPlugin = createMetricsPlugin();
